...
export default class ArtistDetail extends React.Component {
    ...
    render() {
        if (this.props.artist) {
            ...
            let mainImage = require(`../../resources/images/artists/${this.props.artist._id}/main.jpg`);
            let bannerImage = require(`../../resources/images/artists/${this.props.artist._id}/banner.jpg`);
