		...
		return (
			...
			>
				...
				<div className="nav-head">
					<button id="menu" href="#" onClick={this.toggleExpandNav}>
						<Menu />
					</button>
					<Link
						to="/"
				...
				>
					<div
						...
						style={
							this.state.eventsExpanded
								? {
										height: "0"
								  }
								: this.collapseTop &&
								  this.collapseTop.current && {
										height: this.collapseTop.current
											.scrollHeight
								  }
						}
					>
						...
						<div id="social-media">
							<a
								id="facebook"
								href="//www.facebook.com/viceversanz/"
							>
								<Facebook />
							</a>
							<a
								id="instagram"
								href="//www.instagram.com/viceversa_nz/"
							>
								<Instagram />
							</a>
							<a id="bandcamp" href="//viceversanz.bandcamp.com/">
								<Headphones />
							</a>
						</div>
					</div>
					...
					<div
						...
						style={
							this.state.eventsExpanded
								? {
										height: `${this.navContent.current
											.scrollHeight - 2}px`
								  }
								: {
										height:
											this.state.eventsHeight > 0 &&
											`${this.state.eventsHeight}px`
								  }
						}
					>
						<Events
							displayCount={this.state.eventsExpanded ? -1 : 3}
						/>
					</div>
					...
					<div className="break more">
						<button
							...
							className="more"
							href="#"
							onClick={this.toggleExpandEvents}
						>
							{this.state.eventsExpanded ? "Less" : "More"}
						</button>
					</div>
					...
					<div
						...
						style={
							this.state.eventsExpanded
								...
								: this.collapseBottom &&
								  this.collapseBottom.current && {
										height: this.collapseBottom.current
											.scrollHeight
								  }
						}
					>
